...
import com.example.cobafirebase.databinding.FragmentUpdateBinding
...
class UpdateFragment : Fragment() {
    ...
    private fun updateData() {
        ...
        val alamat = binding.edtUpdateAlamat.text.toString()
        val jabatan = binding.edtUpdateJabatan.text.toString()

        var contacts: com.example.cobafirebase.models.Contacts
                ...
                .addOnSuccessListener { task ->
                    task.metadata!!.reference!!.downloadUrl
                        .addOnSuccessListener { url ->
                            ...
                            contacts = com.example.cobafirebase.models.Contacts(args.id, name, phone, email, alamat, jabatan, imageUrl)
